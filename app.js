...
function renderDashboard() {
  ...
  document.querySelector("#copy-file").addEventListener("click", async () => { const button = document.querySelector("#copy-file"); try { await navigator.clipboard.writeText(document.querySelector("#file-content").textContent); button.textContent = t.copied; setTimeout(() => { button.textContent = t.copyText; }, 1600); } catch { button.textContent = t.copyError; } });
