...
function renderDashboard() {
  ...
  document.querySelector("#copy-file").addEventListener("click", async () => { const button = document.querySelector("#copy-file"); try { await navigator.clipboard.writeText(document.querySelector("#file-content").textContent); button.innerHTML = checkIcon; button.title = t.copied; setTimeout(() => { button.innerHTML = copyIcon; button.title = t.copyText; }, 1600); } catch { button.title = t.copyError; } });
